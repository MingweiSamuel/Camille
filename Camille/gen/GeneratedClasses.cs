...
// Version 54a843ecb4e3c9ef28dfeb5b8e50d93513522093
...
namespace MingweiSamuel.Camille
{
    ...
    public class ChampionMasteryEndpoints : Endpoints
    {
        ...
        /// <param name="summonerId">Summoner ID associated with the player (required)></param>
        public ChampionMastery.ChampionMastery GetChampionMastery(Region region, long summonerId, long championId)
        {
        ...
        /// <param name="championId">Champion ID to retrieve Champion Mastery for (required)></param>
        /// <param name="summonerId">Summoner ID associated with the player (required)></param>
        public Task<ChampionMastery.ChampionMastery> GetChampionMasteryAsync(Region region, long summonerId, long championId)
        {
...
namespace MingweiSamuel.Camille.ChampionMastery
{
    ...
    public class ChampionMastery
    {
        ...
        {
            return $"{{ ChestGranted: {ChestGranted}, ChampionLevel: {ChampionLevel}, ChampionPoints: {ChampionPoints}, ChampionId: {ChampionId}, PlayerId: {PlayerId}, ChampionPointsUntilNextLevel: {ChampionPointsUntilNextLevel}, TokensEarned: {TokensEarned}, ChampionPointsSinceLastLevel: {ChampionPointsSinceLastLevel}, LastPlayTime: {LastPlayTime} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Champion
{
    ...
    public class Champion
    {
        ...
        public override string ToString()
        {
            return $"{{ RankedPlayEnabled: {RankedPlayEnabled}, BotEnabled: {BotEnabled}, BotMmEnabled: {BotMmEnabled}, Active: {Active}, FreeToPlay: {FreeToPlay}, Id: {Id} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.League
{
    public class LeagueList
    {
        ...
        public override string ToString()
        {
            return $"{{ LeagueId: {LeagueId}, Tier: {Tier}, Entries: {Entries}, Queue: {Queue}, Name: {Name} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.League
{
    public class MiniSeries
    {
        ...
        public override string ToString()
        {
            return $"{{ Wins: {Wins}, Losses: {Losses}, Target: {Target}, Progress: {Progress} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.League
{
    public class LeaguePosition
    {
        ...
        public override string ToString()
        {
            return $"{{ Rank: {Rank}, QueueType: {QueueType}, HotStreak: {HotStreak}, MiniSeries: {MiniSeries}, Wins: {Wins}, Veteran: {Veteran}, Losses: {Losses}, FreshBlood: {FreshBlood}, LeagueId: {LeagueId}, PlayerOrTeamName: {PlayerOrTeamName}, Inactive: {Inactive}, PlayerOrTeamId: {PlayerOrTeamId}, LeagueName: {LeagueName}, Tier: {Tier}, LeaguePoints: {LeaguePoints} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class ChampionList
    {
        ...
        public override string ToString()
        {
            return $"{{ Keys: {Keys}, Data: {Data}, Version: {Version}, Type: {Type}, Format: {Format} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Champion
    {
        ...
        public override string ToString()
        {
            return $"{{ Info: {Info}, Enemytips: {Enemytips}, Stats: {Stats}, Name: {Name}, Title: {Title}, Image: {Image}, Tags: {Tags}, Partype: {Partype}, Skins: {Skins}, Passive: {Passive}, Recommended: {Recommended}, Allytips: {Allytips}, Key: {Key}, Lore: {Lore}, Id: {Id}, Blurb: {Blurb}, Spells: {Spells} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Info
    {
        ...
        public override string ToString()
        {
            return $"{{ Difficulty: {Difficulty}, Attack: {Attack}, Defense: {Defense}, Magic: {Magic} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Stats
    {
        ...
        public override string ToString()
        {
            return $"{{ Armorperlevel: {Armorperlevel}, Hpperlevel: {Hpperlevel}, Attackdamage: {Attackdamage}, Mpperlevel: {Mpperlevel}, Attackspeedoffset: {Attackspeedoffset}, Armor: {Armor}, Hp: {Hp}, Hpregenperlevel: {Hpregenperlevel}, Spellblock: {Spellblock}, Attackrange: {Attackrange}, Movespeed: {Movespeed}, Attackdamageperlevel: {Attackdamageperlevel}, Mpregenperlevel: {Mpregenperlevel}, Mp: {Mp}, Spellblockperlevel: {Spellblockperlevel}, Crit: {Crit}, Mpregen: {Mpregen}, Attackspeedperlevel: {Attackspeedperlevel}, Hpregen: {Hpregen}, Critperlevel: {Critperlevel} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Image
    {
        ...
        public override string ToString()
        {
            return $"{{ Full: {Full}, Group: {Group}, Sprite: {Sprite}, H: {H}, W: {W}, Y: {Y}, X: {X} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Skin
    {
        ...
        public override string ToString()
        {
            return $"{{ Num: {Num}, Name: {Name}, Id: {Id} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Passive
    {
        ...
        public override string ToString()
        {
            return $"{{ Image: {Image}, SanitizedDescription: {SanitizedDescription}, Name: {Name}, Description: {Description} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Recommended
    {
        ...
        public override string ToString()
        {
            return $"{{ Map: {Map}, Blocks: {Blocks}, Champion: {Champion}, Title: {Title}, Priority: {Priority}, Mode: {Mode}, Type: {Type} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Block
    {
        ...
        public override string ToString()
        {
            return $"{{ Items: {Items}, RecMath: {RecMath}, Type: {Type} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class ChampionSpell
    {
        ...
        public override string ToString()
        {
            return $"{{ CooldownBurn: {CooldownBurn}, Resource: {Resource}, Leveltip: {Leveltip}, Vars: {Vars}, CostType: {CostType}, Image: {Image}, SanitizedDescription: {SanitizedDescription}, SanitizedTooltip: {SanitizedTooltip}, Effect: {Effect}, Tooltip: {Tooltip}, Maxrank: {Maxrank}, CostBurn: {CostBurn}, RangeBurn: {RangeBurn}, Range: {Range}, Cooldown: {Cooldown}, Cost: {Cost}, Key: {Key}, Description: {Description}, EffectBurn: {EffectBurn}, Altimages: {Altimages}, Name: {Name} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class LevelTip
    {
        ...
        public override string ToString()
        {
            return $"{{ Effect: {Effect}, Label: {Label} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class SpellVars
    {
        ...
        public override string ToString()
        {
            return $"{{ RanksWith: {RanksWith}, Dyn: {Dyn}, Link: {Link}, Coeff: {Coeff}, Key: {Key} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class ItemList
    {
        ...
        public override string ToString()
        {
            return $"{{ Data: {Data}, Version: {Version}, Tree: {Tree}, Groups: {Groups}, Type: {Type} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class ItemTree
    {
        ...
        public override string ToString()
        {
            return $"{{ Header: {Header}, Tags: {Tags} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Item
    {
        ...
        public override string ToString()
        {
            return $"{{ Gold: {Gold}, Plaintext: {Plaintext}, HideFromAll: {HideFromAll}, InStore: {InStore}, Into: {Into}, Id: {Id}, Stats: {Stats}, Colloq: {Colloq}, Maps: {Maps}, SpecialRecipe: {SpecialRecipe}, Image: {Image}, Description: {Description}, Tags: {Tags}, Effect: {Effect}, RequiredChampion: {RequiredChampion}, From: {From}, Group: {Group}, ConsumeOnFull: {ConsumeOnFull}, Name: {Name}, Consumed: {Consumed}, SanitizedDescription: {SanitizedDescription}, Depth: {Depth}, Stacks: {Stacks} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Gold
    {
        ...
        public override string ToString()
        {
            return $"{{ Sell: {Sell}, Total: {Total}, Base: {Base}, Purchasable: {Purchasable} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class InventoryDataStats
    {
        ...
        public override string ToString()
        {
            return $"{{ PercentCritDamageMod: {PercentCritDamageMod}, PercentSpellBlockMod: {PercentSpellBlockMod}, PercentHPRegenMod: {PercentHPRegenMod}, PercentMovementSpeedMod: {PercentMovementSpeedMod}, FlatSpellBlockMod: {FlatSpellBlockMod}, FlatCritDamageMod: {FlatCritDamageMod}, FlatEnergyPoolMod: {FlatEnergyPoolMod}, PercentLifeStealMod: {PercentLifeStealMod}, FlatMPPoolMod: {FlatMPPoolMod}, FlatMovementSpeedMod: {FlatMovementSpeedMod}, PercentAttackSpeedMod: {PercentAttackSpeedMod}, FlatBlockMod: {FlatBlockMod}, PercentBlockMod: {PercentBlockMod}, FlatEnergyRegenMod: {FlatEnergyRegenMod}, PercentSpellVampMod: {PercentSpellVampMod}, FlatMPRegenMod: {FlatMPRegenMod}, PercentDodgeMod: {PercentDodgeMod}, FlatAttackSpeedMod: {FlatAttackSpeedMod}, FlatArmorMod: {FlatArmorMod}, FlatHPRegenMod: {FlatHPRegenMod}, PercentMagicDamageMod: {PercentMagicDamageMod}, PercentMPPoolMod: {PercentMPPoolMod}, FlatMagicDamageMod: {FlatMagicDamageMod}, PercentMPRegenMod: {PercentMPRegenMod}, PercentPhysicalDamageMod: {PercentPhysicalDamageMod}, FlatPhysicalDamageMod: {FlatPhysicalDamageMod}, PercentHPPoolMod: {PercentHPPoolMod}, PercentArmorMod: {PercentArmorMod}, PercentCritChanceMod: {PercentCritChanceMod}, PercentEXPBonus: {PercentEXPBonus}, FlatHPPoolMod: {FlatHPPoolMod}, FlatCritChanceMod: {FlatCritChanceMod}, FlatEXPBonus: {FlatEXPBonus} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Group
    {
        ...
        public override string ToString()
        {
            return $"{{ MaxGroupOwnable: {MaxGroupOwnable}, Key: {Key} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class LanguageStrings
    {
        ...
        public override string ToString()
        {
            return $"{{ Data: {Data}, Version: {Version}, Type: {Type} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MapDetails
    {
        ...
        public override string ToString()
        {
            return $"{{ MapName: {MapName}, Image: {Image}, MapId: {MapId}, UnpurchasableItemList: {UnpurchasableItemList} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MasteryList
    {
        ...
        public override string ToString()
        {
            return $"{{ Data: {Data}, Version: {Version}, Tree: {Tree}, Type: {Type} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MasteryTree
    {
        ...
        public override string ToString()
        {
            return $"{{ Resolve: {Resolve}, Ferocity: {Ferocity}, Cunning: {Cunning} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MasteryTreeList
    {
        ...
        public override string ToString()
        {
            return $"{{ MasteryTreeItems: {MasteryTreeItems} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MasteryTreeItem
    {
        ...
        public override string ToString()
        {
            return $"{{ MasteryId: {MasteryId}, Prereq: {Prereq} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Mastery
    {
        ...
        public override string ToString()
        {
            return $"{{ Prereq: {Prereq}, MasteryTree: {MasteryTree}, Name: {Name}, Ranks: {Ranks}, Image: {Image}, SanitizedDescription: {SanitizedDescription}, Id: {Id}, Description: {Description} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Realm
    {
        ...
        public override string ToString()
        {
            return $"{{ Lg: {Lg}, Dd: {Dd}, L: {L}, N: {N}, Profileiconmax: {Profileiconmax}, Store: {Store}, V: {V}, Cdn: {Cdn}, Css: {Css} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class Rune
    {
        ...
        public override string ToString()
        {
            return $"{{ Stats: {Stats}, Name: {Name}, Tags: {Tags}, Image: {Image}, SanitizedDescription: {SanitizedDescription}, RuneMetaData: {RuneMetaData}, Id: {Id}, Description: {Description} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class RuneStats
    {
        ...
        public override string ToString()
        {
            return $"{{ PercentTimeDeadModPerLevel: {PercentTimeDeadModPerLevel}, PercentArmorPenetrationModPerLevel: {PercentArmorPenetrationModPerLevel}, PercentCritDamageMod: {PercentCritDamageMod}, PercentSpellBlockMod: {PercentSpellBlockMod}, PercentHPRegenMod: {PercentHPRegenMod}, PercentMovementSpeedMod: {PercentMovementSpeedMod}, FlatSpellBlockMod: {FlatSpellBlockMod}, FlatEnergyRegenModPerLevel: {FlatEnergyRegenModPerLevel}, FlatEnergyPoolMod: {FlatEnergyPoolMod}, FlatMagicPenetrationModPerLevel: {FlatMagicPenetrationModPerLevel}, PercentLifeStealMod: {PercentLifeStealMod}, FlatMPPoolMod: {FlatMPPoolMod}, PercentCooldownMod: {PercentCooldownMod}, PercentMagicPenetrationMod: {PercentMagicPenetrationMod}, FlatArmorPenetrationModPerLevel: {FlatArmorPenetrationModPerLevel}, FlatMovementSpeedMod: {FlatMovementSpeedMod}, FlatTimeDeadModPerLevel: {FlatTimeDeadModPerLevel}, FlatArmorModPerLevel: {FlatArmorModPerLevel}, PercentAttackSpeedMod: {PercentAttackSpeedMod}, FlatDodgeModPerLevel: {FlatDodgeModPerLevel}, PercentMagicDamageMod: {PercentMagicDamageMod}, PercentBlockMod: {PercentBlockMod}, FlatDodgeMod: {FlatDodgeMod}, FlatEnergyRegenMod: {FlatEnergyRegenMod}, FlatHPModPerLevel: {FlatHPModPerLevel}, PercentAttackSpeedModPerLevel: {PercentAttackSpeedModPerLevel}, PercentSpellVampMod: {PercentSpellVampMod}, FlatMPRegenMod: {FlatMPRegenMod}, PercentHPPoolMod: {PercentHPPoolMod}, PercentDodgeMod: {PercentDodgeMod}, FlatAttackSpeedMod: {FlatAttackSpeedMod}, FlatArmorMod: {FlatArmorMod}, FlatMagicDamageModPerLevel: {FlatMagicDamageModPerLevel}, FlatHPRegenMod: {FlatHPRegenMod}, PercentPhysicalDamageMod: {PercentPhysicalDamageMod}, FlatCritChanceModPerLevel: {FlatCritChanceModPerLevel}, FlatSpellBlockModPerLevel: {FlatSpellBlockModPerLevel}, PercentTimeDeadMod: {PercentTimeDeadMod}, FlatBlockMod: {FlatBlockMod}, PercentMPPoolMod: {PercentMPPoolMod}, FlatMagicDamageMod: {FlatMagicDamageMod}, PercentMPRegenMod: {PercentMPRegenMod}, PercentMovementSpeedModPerLevel: {PercentMovementSpeedModPerLevel}, PercentCooldownModPerLevel: {PercentCooldownModPerLevel}, FlatMPModPerLevel: {FlatMPModPerLevel}, FlatEnergyModPerLevel: {FlatEnergyModPerLevel}, FlatPhysicalDamageMod: {FlatPhysicalDamageMod}, FlatHPRegenModPerLevel: {FlatHPRegenModPerLevel}, FlatCritDamageMod: {FlatCritDamageMod}, PercentArmorMod: {PercentArmorMod}, FlatMagicPenetrationMod: {FlatMagicPenetrationMod}, PercentCritChanceMod: {PercentCritChanceMod}, FlatPhysicalDamageModPerLevel: {FlatPhysicalDamageModPerLevel}, PercentArmorPenetrationMod: {PercentArmorPenetrationMod}, PercentEXPBonus: {PercentEXPBonus}, FlatMPRegenModPerLevel: {FlatMPRegenModPerLevel}, PercentMagicPenetrationModPerLevel: {PercentMagicPenetrationModPerLevel}, FlatTimeDeadMod: {FlatTimeDeadMod}, FlatMovementSpeedModPerLevel: {FlatMovementSpeedModPerLevel}, FlatGoldPer10Mod: {FlatGoldPer10Mod}, FlatArmorPenetrationMod: {FlatArmorPenetrationMod}, FlatCritDamageModPerLevel: {FlatCritDamageModPerLevel}, FlatHPPoolMod: {FlatHPPoolMod}, FlatCritChanceMod: {FlatCritChanceMod}, FlatEXPBonus: {FlatEXPBonus} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class MetaData
    {
        ...
        public override string ToString()
        {
            return $"{{ Tier: {Tier}, Type: {Type}, IsRune: {IsRune} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStaticData
{
    ...
    public class SummonerSpell
    {
        ...
        public override string ToString()
        {
            return $"{{ Vars: {Vars}, Image: {Image}, CostBurn: {CostBurn}, Cooldown: {Cooldown}, EffectBurn: {EffectBurn}, Id: {Id}, CooldownBurn: {CooldownBurn}, Tooltip: {Tooltip}, Maxrank: {Maxrank}, RangeBurn: {RangeBurn}, Description: {Description}, Effect: {Effect}, Key: {Key}, Leveltip: {Leveltip}, Modes: {Modes}, Resource: {Resource}, Name: {Name}, CostType: {CostType}, SanitizedDescription: {SanitizedDescription}, SanitizedTooltip: {SanitizedTooltip}, Range: {Range}, Cost: {Cost}, SummonerLevel: {SummonerLevel} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStatus
{
    public class ShardStatus
    {
        ...
        public override string ToString()
        {
            return $"{{ Name: {Name}, RegionTag: {RegionTag}, Hostname: {Hostname}, Services: {Services}, Slug: {Slug}, Locales: {Locales} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStatus
{
    public class Service
    {
        ...
        public override string ToString()
        {
            return $"{{ Status: {Status}, Incidents: {Incidents}, Name: {Name}, Slug: {Slug} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStatus
{
    public class Incident
    {
        ...
        public override string ToString()
        {
            return $"{{ Active: {Active}, CreatedAt: {CreatedAt}, Id: {Id}, Updates: {Updates} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStatus
{
    public class Message
    {
        ...
        public override string ToString()
        {
            return $"{{ Severity: {Severity}, Author: {Author}, CreatedAt: {CreatedAt}, Translations: {Translations}, UpdatedAt: {UpdatedAt}, Content: {Content}, Id: {Id} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.LolStatus
{
    public class Translation
    {
        ...
        public override string ToString()
        {
            return $"{{ Locale: {Locale}, Content: {Content}, UpdatedAt: {UpdatedAt} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Match
    {
        ...
        public override string ToString()
        {
            return $"{{ SeasonId: {SeasonId}, QueueId: {QueueId}, GameId: {GameId}, ParticipantIdentities: {ParticipantIdentities}, GameVersion: {GameVersion}, PlatformId: {PlatformId}, GameMode: {GameMode}, MapId: {MapId}, GameType: {GameType}, Teams: {Teams}, Participants: {Participants}, GameDuration: {GameDuration}, GameCreation: {GameCreation} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class ParticipantIdentity
    {
        ...
        public override string ToString()
        {
            return $"{{ Player: {Player}, ParticipantId: {ParticipantId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Player
    {
        ...
        public override string ToString()
        {
            return $"{{ CurrentPlatformId: {CurrentPlatformId}, SummonerName: {SummonerName}, MatchHistoryUri: {MatchHistoryUri}, PlatformId: {PlatformId}, CurrentAccountId: {CurrentAccountId}, ProfileIcon: {ProfileIcon}, SummonerId: {SummonerId}, AccountId: {AccountId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class TeamStats
    {
        ...
        public override string ToString()
        {
            return $"{{ FirstDragon: {FirstDragon}, FirstInhibitor: {FirstInhibitor}, Bans: {Bans}, BaronKills: {BaronKills}, FirstRiftHerald: {FirstRiftHerald}, FirstBaron: {FirstBaron}, RiftHeraldKills: {RiftHeraldKills}, FirstBlood: {FirstBlood}, TeamId: {TeamId}, FirstTower: {FirstTower}, VilemawKills: {VilemawKills}, InhibitorKills: {InhibitorKills}, TowerKills: {TowerKills}, DominionVictoryScore: {DominionVictoryScore}, Win: {Win}, DragonKills: {DragonKills} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class TeamBans
    {
        ...
        public override string ToString()
        {
            return $"{{ PickTurn: {PickTurn}, ChampionId: {ChampionId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Participant
    {
        ...
        public override string ToString()
        {
            return $"{{ Stats: {Stats}, ParticipantId: {ParticipantId}, Runes: {Runes}, Timeline: {Timeline}, TeamId: {TeamId}, Spell2Id: {Spell2Id}, Masteries: {Masteries}, HighestAchievedSeasonTier: {HighestAchievedSeasonTier}, Spell1Id: {Spell1Id}, ChampionId: {ChampionId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class ParticipantStats
    {
        ...
        public override string ToString()
        {
            return $"{{ PhysicalDamageDealt: {PhysicalDamageDealt}, NeutralMinionsKilledTeamJungle: {NeutralMinionsKilledTeamJungle}, MagicDamageDealt: {MagicDamageDealt}, TotalPlayerScore: {TotalPlayerScore}, Deaths: {Deaths}, Win: {Win}, NeutralMinionsKilledEnemyJungle: {NeutralMinionsKilledEnemyJungle}, AltarsCaptured: {AltarsCaptured}, LargestCriticalStrike: {LargestCriticalStrike}, TotalDamageDealt: {TotalDamageDealt}, MagicDamageDealtToChampions: {MagicDamageDealtToChampions}, VisionWardsBoughtInGame: {VisionWardsBoughtInGame}, DamageDealtToObjectives: {DamageDealtToObjectives}, LargestKillingSpree: {LargestKillingSpree}, Item1: {Item1}, QuadraKills: {QuadraKills}, TeamObjective: {TeamObjective}, TotalTimeCrowdControlDealt: {TotalTimeCrowdControlDealt}, LongestTimeSpentLiving: {LongestTimeSpentLiving}, WardsKilled: {WardsKilled}, FirstTowerAssist: {FirstTowerAssist}, FirstTowerKill: {FirstTowerKill}, Item2: {Item2}, Item3: {Item3}, Item0: {Item0}, FirstBloodAssist: {FirstBloodAssist}, VisionScore: {VisionScore}, WardsPlaced: {WardsPlaced}, Item4: {Item4}, Item5: {Item5}, Item6: {Item6}, TurretKills: {TurretKills}, TripleKills: {TripleKills}, DamageSelfMitigated: {DamageSelfMitigated}, ChampLevel: {ChampLevel}, NodeNeutralizeAssist: {NodeNeutralizeAssist}, FirstInhibitorKill: {FirstInhibitorKill}, GoldEarned: {GoldEarned}, MagicalDamageTaken: {MagicalDamageTaken}, Kills: {Kills}, DoubleKills: {DoubleKills}, NodeCaptureAssist: {NodeCaptureAssist}, TrueDamageTaken: {TrueDamageTaken}, NodeNeutralize: {NodeNeutralize}, FirstInhibitorAssist: {FirstInhibitorAssist}, Assists: {Assists}, UnrealKills: {UnrealKills}, NeutralMinionsKilled: {NeutralMinionsKilled}, ObjectivePlayerScore: {ObjectivePlayerScore}, CombatPlayerScore: {CombatPlayerScore}, DamageDealtToTurrets: {DamageDealtToTurrets}, AltarsNeutralized: {AltarsNeutralized}, PhysicalDamageDealtToChampions: {PhysicalDamageDealtToChampions}, GoldSpent: {GoldSpent}, TrueDamageDealt: {TrueDamageDealt}, TrueDamageDealtToChampions: {TrueDamageDealtToChampions}, ParticipantId: {ParticipantId}, PentaKills: {PentaKills}, TotalHeal: {TotalHeal}, TotalMinionsKilled: {TotalMinionsKilled}, FirstBloodKill: {FirstBloodKill}, NodeCapture: {NodeCapture}, LargestMultiKill: {LargestMultiKill}, SightWardsBoughtInGame: {SightWardsBoughtInGame}, TotalDamageDealtToChampions: {TotalDamageDealtToChampions}, TotalUnitsHealed: {TotalUnitsHealed}, InhibitorKills: {InhibitorKills}, TotalScoreRank: {TotalScoreRank}, TotalDamageTaken: {TotalDamageTaken}, KillingSprees: {KillingSprees}, TimeCCingOthers: {TimeCCingOthers}, PhysicalDamageTaken: {PhysicalDamageTaken} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Rune
    {
        ...
        public override string ToString()
        {
            return $"{{ RuneId: {RuneId}, Rank: {Rank} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Mastery
    {
        ...
        public override string ToString()
        {
            return $"{{ MasteryId: {MasteryId}, Rank: {Rank} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class Matchlist
    {
        ...
        public override string ToString()
        {
            return $"{{ Matches: {Matches}, TotalGames: {TotalGames}, StartIndex: {StartIndex}, EndIndex: {EndIndex} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class MatchReference
    {
        ...
        public override string ToString()
        {
            return $"{{ Lane: {Lane}, GameId: {GameId}, Champion: {Champion}, PlatformId: {PlatformId}, Season: {Season}, Queue: {Queue}, Role: {Role}, Timestamp: {Timestamp} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class MatchTimeline
    {
        ...
        public override string ToString()
        {
            return $"{{ Frames: {Frames}, FrameInterval: {FrameInterval} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class MatchFrame
    {
        ...
        public override string ToString()
        {
            return $"{{ Timestamp: {Timestamp}, ParticipantFrames: {ParticipantFrames}, Events: {Events} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Match
{
    public class MatchParticipantFrame
    {
        ...
        public override string ToString()
        {
            return $"{{ TotalGold: {TotalGold}, TeamScore: {TeamScore}, ParticipantId: {ParticipantId}, Level: {Level}, CurrentGold: {CurrentGold}, MinionsKilled: {MinionsKilled}, DominionScore: {DominionScore}, Position: {Position}, Xp: {Xp}, JungleMinionsKilled: {JungleMinionsKilled} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Spectator
{
    public class CurrentGameInfo
    {
        ...
        public override string ToString()
        {
            return $"{{ GameId: {GameId}, GameStartTime: {GameStartTime}, PlatformId: {PlatformId}, GameMode: {GameMode}, MapId: {MapId}, GameType: {GameType}, BannedChampions: {BannedChampions}, Observers: {Observers}, Participants: {Participants}, GameLength: {GameLength}, GameQueueConfigId: {GameQueueConfigId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Spectator
{
    public class CurrentGameParticipant
    {
        ...
        public override string ToString()
        {
            return $"{{ ProfileIconId: {ProfileIconId}, ChampionId: {ChampionId}, SummonerName: {SummonerName}, GameCustomizationObjects: {GameCustomizationObjects}, Bot: {Bot}, Perks: {Perks}, Spell2Id: {Spell2Id}, TeamId: {TeamId}, Spell1Id: {Spell1Id}, SummonerId: {SummonerId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Spectator
{
    public class Perks
    {
        ...
        public override string ToString()
        {
            return $"{{ PerkStyle: {PerkStyle}, PerkIds: {PerkIds}, PerkSubStyle: {PerkSubStyle} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Spectator
{
    public class FeaturedGames
    {
        ...
        public override string ToString()
        {
            return $"{{ ClientRefreshInterval: {ClientRefreshInterval}, GameList: {GameList} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Spectator
{
    public class Participant
    {
        ...
        public override string ToString()
        {
            return $"{{ ProfileIconId: {ProfileIconId}, ChampionId: {ChampionId}, SummonerName: {SummonerName}, Bot: {Bot}, Spell2Id: {Spell2Id}, TeamId: {TeamId}, Spell1Id: {Spell1Id} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Summoner
{
    ...
    public class Summoner
    {
        ...
        public override string ToString()
        {
            return $"{{ ProfileIconId: {ProfileIconId}, Name: {Name}, SummonerLevel: {SummonerLevel}, RevisionDate: {RevisionDate}, Id: {Id}, AccountId: {AccountId} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.TournamentStub
{
    public class TournamentCodeParameters
    {
        ...
        public override string ToString()
        {
            return $"{{ SpectatorType: {SpectatorType}, TeamSize: {TeamSize}, PickType: {PickType}, AllowedSummonerIds: {AllowedSummonerIds}, MapType: {MapType}, Metadata: {Metadata} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.TournamentStub
{
    public class LobbyEvent
    {
        ...
        public override string ToString()
        {
            return $"{{ EventType: {EventType}, SummonerId: {SummonerId}, Timestamp: {Timestamp} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.TournamentStub
{
    public class TournamentRegistrationParameters
    {
        ...
        public override string ToString()
        {
            return $"{{ ProviderId: {ProviderId}, Name: {Name} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Tournament
{
    public class TournamentCodeUpdateParameters
    {
        ...
        public override string ToString()
        {
            return $"{{ SpectatorType: {SpectatorType}, PickType: {PickType}, AllowedParticipants: {AllowedParticipants}, MapType: {MapType} }}";
        }
    }
}
...
namespace MingweiSamuel.Camille.Tournament
{
    public class TournamentCode
    {
        ...
        public override string ToString()
        {
            return $"{{ Map: {Map}, Code: {Code}, Spectators: {Spectators}, Region: {Region}, ProviderId: {ProviderId}, TeamSize: {TeamSize}, Participants: {Participants}, PickType: {PickType}, TournamentId: {TournamentId}, LobbyName: {LobbyName}, Password: {Password}, Id: {Id}, MetaData: {MetaData} }}";
        }
    }
}
