...
// Generated on 2023-06-08T02:50:21.966Z

// http://www.mingweisamuel.com/riotapi-schema/tool/
// Version 85a8642eddf39f9ff0b7c44f3563361bc8ea81c9
...
namespace MingweiSamuel.Camille
{
    ...
    public class ChampionMasteryV4Endpoints : Endpoints
    {
        ...
        /// Official API Reference: <a href="https://developer.riotgames.com/api-methods/#champion-mastery-v4/GET_getAllChampionMasteriesByPUUID">https://developer.riotgames.com/api-methods/#champion-mastery-v4/GET_getAllChampionMasteriesByPUUID</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="encryptedPUUID"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public ChampionMasteryV4.ChampionMastery[]? GetAllChampionMasteriesByPUUID(Region region, string encryptedPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<ChampionMasteryV4.ChampionMastery[]?>("champion-mastery-v4.getAllChampionMasteriesByPUUID", $"/lol/champion-mastery/v4/champion-masteries/by-puuid/{encryptedPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <param name="encryptedPUUID"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<ChampionMasteryV4.ChampionMastery[]?> GetAllChampionMasteriesByPUUIDAsync(Region region, string encryptedPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<ChampionMasteryV4.ChampionMastery[]?>("champion-mastery-v4.getAllChampionMasteriesByPUUID", $"/lol/champion-mastery/v4/champion-masteries/by-puuid/{encryptedPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <summary>
        /// Get specified number of top champion mastery entries sorted by number of champion points descending.<para />
        /// Official API Reference: <a href="https://developer.riotgames.com/api-methods/#champion-mastery-v4/GET_getTopChampionMasteries">https://developer.riotgames.com/api-methods/#champion-mastery-v4/GET_getTopChampionMasteries</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="encryptedSummonerId">Summoner ID associated with the player (required)</param>
        /// <param name="count">Number of entries to retrieve, defaults to 3 (optional)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public ChampionMasteryV4.ChampionMastery[]? GetTopChampionMasteries(Region region, string encryptedSummonerId, int? count = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string, string>>();
            if (null != count) queryParams.Add(new KeyValuePair<string, string>(nameof(count), count.Value.ToString()));
            return RiotApi.Get<ChampionMasteryV4.ChampionMastery[]?>("champion-mastery-v4.getTopChampionMasteries", $"/lol/champion-mastery/v4/champion-masteries/by-summoner/{encryptedSummonerId}/top",
        ...
        /// <param name="count">Number of entries to retrieve, defaults to 3 (optional)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<ChampionMasteryV4.ChampionMastery[]?> GetTopChampionMasteriesAsync(Region region, string encryptedSummonerId, int? count = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string, string>>();
            if (null != count) queryParams.Add(new KeyValuePair<string, string>(nameof(count), count.Value.ToString()));
            return RiotApi.GetAsync<ChampionMasteryV4.ChampionMastery[]?>("champion-mastery-v4.getTopChampionMasteries", $"/lol/champion-mastery/v4/champion-masteries/by-summoner/{encryptedSummonerId}/top",
                region, queryParams, false, cancellationToken);
        }
    ...
    public class ClashV1Endpoints : Endpoints
    {
        ...
        /// <summary>
        /// Get players by puuid<para />
        /// ## Implementation Notes<para />
        /// This endpoint returns a list of active Clash players for a given PUUID. If a summoner registers for multiple tournaments at the same time (e.g., Saturday and Sunday) then both registrations would appear in this list.<para />
        /// Official API Reference: <a href="https://developer.riotgames.com/api-methods/#clash-v1/GET_getPlayersByPUUID">https://developer.riotgames.com/api-methods/#clash-v1/GET_getPlayersByPUUID</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="encryptedPUUID"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public ClashV1.Player[]? GetPlayersByPUUID(Region region, string encryptedPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<ClashV1.Player[]?>("clash-v1.getPlayersByPUUID", $"/lol/clash/v1/players/by-puuid/{encryptedPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <param name="encryptedPUUID"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<ClashV1.Player[]?> GetPlayersByPUUIDAsync(Region region, string encryptedPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<ClashV1.Player[]?>("clash-v1.getPlayersByPUUID", $"/lol/clash/v1/players/by-puuid/{encryptedPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
    ...
    public class SummonerV4Endpoints : Endpoints
    {
        ...
        /// <summary>
        /// Get a summoner by its RSO encrypted PUUID.<para />
        /// Official API Reference: <a href="https://developer.riotgames.com/api-methods/#summoner-v4/GET_getByRSOPUUID">https://developer.riotgames.com/api-methods/#summoner-v4/GET_getByRSOPUUID</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="rsoPUUID">Summoner ID (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public SummonerV4.Summoner? GetByRSOPUUID(Region region, string rsoPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<SummonerV4.Summoner?>("summoner-v4.getByRSOPUUID", $"/fulfillment/v1/summoners/by-puuid/{rsoPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <param name="rsoPUUID">Summoner ID (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<SummonerV4.Summoner?> GetByRSOPUUIDAsync(Region region, string rsoPUUID, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<SummonerV4.Summoner?>("summoner-v4.getByRSOPUUID", $"/fulfillment/v1/summoners/by-puuid/{rsoPUUID}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
    ...
    /// <summary>
    /// TftStatusV1 endpoints. This class is automatically generated.<para />
    /// Official API Reference <a href="https://developer.riotgames.com/api-methods/#tft-status-v1">https://developer.riotgames.com/api-methods/#tft-status-v1</a>
    /// </summary>
    public class TftStatusV1Endpoints : Endpoints
    {
        internal TftStatusV1Endpoints(RiotApi riotApi) : base(riotApi)
        {}

        /// <summary>
        /// Get Teamfight Tactics status for the given platform.<para />
        /// Official API Reference: <a href="https://developer.riotgames.com/api-methods/#tft-status-v1/GET_getPlatformData">https://developer.riotgames.com/api-methods/#tft-status-v1/GET_getPlatformData</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public TftStatusV1.PlatformData? GetPlatformData(Region region, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<TftStatusV1.PlatformData?>("tft-status-v1.getPlatformData", $"/tft/status/v1/platform-data",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <param name="region">Region to query.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<TftStatusV1.PlatformData?> GetPlatformDataAsync(Region region, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<TftStatusV1.PlatformData?>("tft-status-v1.getPlatformData", $"/tft/status/v1/platform-data",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
