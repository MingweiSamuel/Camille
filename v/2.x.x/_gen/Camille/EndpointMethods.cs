...
// Generated on 2020-07-15T03:05:11.152Z
...
namespace MingweiSamuel.Camille
{
    ...
    public class AccountV1Endpoints : Endpoints
    {
        ...
        {
            return RiotApi.Get<string?>("account-v1.getByRiotId", $"/riot/account/v1/accounts/by-riot-id/{gameName}/{tagLine}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        {
            return RiotApi.GetAsync<string?>("account-v1.getByRiotId", $"/riot/account/v1/accounts/by-riot-id/{gameName}/{tagLine}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
