...
// Generated on 2020-09-15T01:31:34.120Z
...
namespace MingweiSamuel.Camille
{
    ...
    public class ValMatchV1Endpoints : Endpoints
    {
        ...
        /// <param name="queue"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public string? GetRecent(Region region, string queue, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<string?>("val-match-v1.getRecent", $"/val/match/v1/recent-matches/by-queue/{queue}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        /// <param name="queue"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<string?> GetRecentAsync(Region region, string queue, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<string?>("val-match-v1.getRecent", $"/val/match/v1/recent-matches/by-queue/{queue}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
