...
// Generated on 2022-01-19T02:15:01.851Z
...
namespace Camille.Lcu
{
    ...
    public class LolRankedEndpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LolRanked.LeagueLadderInfo GetApexLeaguesByQueueTypeByTierV1(Camille.Enums.QueueType queueType, Camille.Enums.Tier tier, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="tier">(required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LolRanked.LeagueLadderInfo> GetApexLeaguesByQueueTypeByTierV1Async(Camille.Enums.QueueType queueType, Camille.Enums.Tier tier, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LolRanked.ParticipantTiers[] GetTiersV2(long[] summonerIds, Camille.Enums.QueueType[] queueTypes, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queueTypes">(required, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LolRanked.ParticipantTiers[]> GetTiersV2Async(long[] summonerIds, Camille.Enums.QueueType[] queueTypes, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
    ...
    public class LolSummonerEndpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LolSummoner.AutoFillQueue[] GetCurrentSummonerAutofillV1(CancellationToken? cancellationToken = null)
        {
            return GetCurrentSummonerAutofillV1Async(cancellationToken).Result;
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LolSummoner.AutoFillQueue[]> GetCurrentSummonerAutofillV1Async(CancellationToken? cancellationToken = null)
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"/lol-summoner/v1/current-summoner/autofill");
            return @base.Send<LolSummoner.AutoFillQueue[]>(request, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LolSummoner.Summoner PostSummonersV1(LolSummoner.SummonerRequestedName body, CancellationToken? cancellationToken = null)
        {
            return PostSummonersV1Async(body, cancellationToken).Result;
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LolSummoner.Summoner> PostSummonersV1Async(LolSummoner.SummonerRequestedName body, CancellationToken? cancellationToken = null)
        {
    ...
    /// <summary>
    /// Global endpoints. This class is automatically generated.<para />
    /// Official API Reference <a href="https://developer.riotgames.com/api-methods/#global">https://developer.riotgames.com/api-methods/#global</a>
    /// </summary>
    public class GlobalEndpoints : Endpoints
    {
        internal GlobalEndpoints(ILcuApi @base) : base(@base)
        {}

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientKillAndRestartUx(CancellationToken? cancellationToken = null)
        {
            PostRiotclientKillAndRestartUxAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientKillAndRestartUxAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientKillUx(CancellationToken? cancellationToken = null)
        {
            PostRiotclientKillUxAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientKillUxAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientLaunchUx(CancellationToken? cancellationToken = null)
        {
            PostRiotclientLaunchUxAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientLaunchUxAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Global.RegionLocale GetRiotclientRegionLocale(CancellationToken? cancellationToken = null)
        {
            return GetRiotclientRegionLocaleAsync(cancellationToken).Result;
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<Global.RegionLocale> GetRiotclientRegionLocaleAsync(CancellationToken? cancellationToken = null)
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"/riotclient/region-locale");
            return @base.Send<Global.RegionLocale>(request, cancellationToken);
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PutRiotclientRegionLocale(Global.RegionLocale body, CancellationToken? cancellationToken = null)
        {
            PutRiotclientRegionLocaleAsync(body, cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PutRiotclientRegionLocaleAsync(Global.RegionLocale body, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientUnload(CancellationToken? cancellationToken = null)
        {
            PostRiotclientUnloadAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientUnloadAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientUxFlash(CancellationToken? cancellationToken = null)
        {
            PostRiotclientUxFlashAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientUxFlashAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientUxMinimize(CancellationToken? cancellationToken = null)
        {
            PostRiotclientUxMinimizeAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientUxMinimizeAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void PostRiotclientUxShow(CancellationToken? cancellationToken = null)
        {
            PostRiotclientUxShowAsync(cancellationToken).Wait();
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task PostRiotclientUxShowAsync(CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string GetRiotclientUxState(CancellationToken? cancellationToken = null)
        {
            return GetRiotclientUxStateAsync(cancellationToken).Result;
        }

        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string> GetRiotclientUxStateAsync(CancellationToken? cancellationToken = null)
        {
