...
// Generated on 2020-07-21T03:11:47.589Z
...
namespace Camille.RiotApi
{
    ...
    public class AccountV1Endpoints : Endpoints
    {
        ...
        {
            return GetByPuuidAsync(region, puuid, cancellationToken).Result;
        }
        ...
        public Task<AccountV1.Account> GetByPuuidAsync(Region region, string puuid, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<AccountV1.Account>(region, "account-v1.getByPuuid", request, cancellationToken, false);
        }
        ...
        {
            return GetByRiotIdAsync(region, gameName, tagLine, cancellationToken).Result;
        }
        ...
        public Task<AccountV1.Account> GetByRiotIdAsync(Region region, string gameName, string tagLine, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<AccountV1.Account>(region, "account-v1.getByRiotId", request, cancellationToken, false);
        }
        ...
        {
            return GetActiveShardAsync(region, game, puuid, cancellationToken).Result;
        }
        ...
        public Task<AccountV1.ActiveShard> GetActiveShardAsync(Region region, string game, string puuid, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<AccountV1.ActiveShard>(region, "account-v1.getActiveShard", request, cancellationToken, false);
        }
    ...
    public class ClashV1Endpoints : Endpoints
    {
        ...
        {
            return GetPlayersBySummonerAsync(region, summonerId, cancellationToken).Result;
        }
        ...
        public Task<ClashV1.Player[]> GetPlayersBySummonerAsync(Region region, string summonerId, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ClashV1.Player[]>(region, "clash-v1.getPlayersBySummoner", request, cancellationToken, false);
        }
        ...
        {
            return GetTeamByIdAsync(region, teamId, cancellationToken).Result;
        }
        ...
        public Task<ClashV1.Team?> GetTeamByIdAsync(Region region, string teamId, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ClashV1.Team?>(region, "clash-v1.getTeamById", request, cancellationToken, false);
        }
        ...
        {
            return GetTournamentsAsync(region, cancellationToken).Result;
        }
        ...
        public Task<ClashV1.Tournament[]> GetTournamentsAsync(Region region, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ClashV1.Tournament[]>(region, "clash-v1.getTournaments", request, cancellationToken, false);
        }
        ...
        {
            return GetTournamentByTeamAsync(region, teamId, cancellationToken).Result;
        }
        ...
        public Task<ClashV1.Tournament?> GetTournamentByTeamAsync(Region region, string teamId, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ClashV1.Tournament?>(region, "clash-v1.getTournamentByTeam", request, cancellationToken, false);
        }
        ...
        {
            return GetTournamentByIdAsync(region, tournamentId, cancellationToken).Result;
        }
        ...
        public Task<ClashV1.Tournament?> GetTournamentByIdAsync(Region region, int tournamentId, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ClashV1.Tournament?>(region, "clash-v1.getTournamentById", request, cancellationToken, false);
        }
    ...
    public class ValContentV1Endpoints : Endpoints
    {
        ...
        {
            return GetContentAsync(region, locale, cancellationToken).Result;
        }
        ...
        public Task<ValContentV1.Content> GetContentAsync(Region region, string? locale = null, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ValContentV1.Content>(region, "val-content-v1.getContent", request, cancellationToken, false);
        }
    ...
    public class ValMatchV1Endpoints : Endpoints
    {
        ...
        public Task<ValMatchV1.Match> GetMatchAsync(Region region, string matchId, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ValMatchV1.Match>(region, "val-match-v1.getMatch", request, cancellationToken, false);
        }
        ...
        {
            return GetMatchlistAsync(region, puuid, cancellationToken).Result;
        }
        ...
        public Task<ValMatchV1.Matchlist> GetMatchlistAsync(Region region, string puuid, CancellationToken? cancellationToken = null)
        {
            ...
            return RiotApi.Send<ValMatchV1.Matchlist>(region, "val-match-v1.getMatchlist", request, cancellationToken, false);
        }
