...
// Generated on 2020-07-14T03:11:18.718Z
...
namespace Camille.RiotApi
{
    ...
    public class AccountV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string GetByRiotId(Region region, string gameName, string tagLine, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="gameName">(required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string> GetByRiotIdAsync(Region region, string gameName, string tagLine, CancellationToken? cancellationToken = null)
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"/riot/account/v1/accounts/by-riot-id/{gameName}/{tagLine}");
            return RiotApi.Send<string>(region, "account-v1.getByRiotId", request, cancellationToken, false);
        }
