...
namespace Camille.RiotApi
{
    ...
    public class ClashV1Endpoints : Endpoints
    {
        ...
        /// <summary>
        /// Get players by summoner ID.<para />        /// ## Implementation Notes<para />        /// This endpoint returns a list of active Clash players for a given summoner ID. If a summoner registers for multiple tournaments at the same time (e.g., Saturday and Sunday) then both registrations would appear in this list.
