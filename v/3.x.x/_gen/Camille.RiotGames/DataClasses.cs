...
// Generated on 2021-08-25T02:20:57.861Z

// http://www.mingweisamuel.com/riotapi-schema/tool/
// Version 55f7b56950a40b9d3ecfeb6b3f9d166ec0824f4a
...
namespace Camille.RiotGames.MatchV4
{
    /// <summary>
    /// Match data object. This class is automatically generated.<para />
    /// 
...
namespace Camille.RiotGames.MatchV5
{
    ...
    /// individualPosition vs teamPosition:<para />
    /// <para />
    /// Both individualPosition and teamPosition are computed by the game server and are different versions of the most likely position played by a player.<para />
    /// <para />
    /// The individualPosition is the best guess for which position the player actually played in isolation of anything else.<para />
    /// The teamPosition is the best guess for which position the player actually played if we add the constraint that each team must have one top player, one jungle, one middle, et cetera.<para />
    /// <para />
    /// Generally the recommendation is to use the teamPosition field for things relating to which position the player actually played.<para />
    /// <para />
