...
// Generated on 2021-10-24T00:15:58.278Z
...
namespace Camille.RiotGames
{
    ...
    public class ChampionMasteryV4Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ChampionMasteryV4.ChampionMastery? GetChampionMastery(PlatformRoute route, string encryptedSummonerId, Camille.Enums.Champion championId, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="encryptedSummonerId">Summoner ID associated with the player (required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<ChampionMasteryV4.ChampionMastery?> GetChampionMasteryAsync(PlatformRoute route, string encryptedSummonerId, Camille.Enums.Champion championId, CancellationToken? cancellationToken = null)
        {
    ...
    public class LeagueExpV4Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LeagueExpV4.LeagueEntry[] GetLeagueEntries(PlatformRoute route, Camille.Enums.QueueType queue, Camille.Enums.Tier tier, Camille.Enums.Division division, int? page = null, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="page">Defaults to 1. Starts with page 1. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LeagueExpV4.LeagueEntry[]> GetLeagueEntriesAsync(PlatformRoute route, Camille.Enums.QueueType queue, Camille.Enums.Tier tier, Camille.Enums.Division division, int? page = null, CancellationToken? cancellationToken = null)
        {
    ...
    public class LeagueV4Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LeagueV4.LeagueList GetChallengerLeague(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LeagueV4.LeagueList> GetChallengerLeagueAsync(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LeagueV4.LeagueEntry[] GetLeagueEntries(PlatformRoute route, Camille.Enums.QueueType queue, Camille.Enums.Tier tier, Camille.Enums.Division division, int? page = null, CancellationToken? cancellationToken = null)
        {
            return GetLeagueEntriesAsync(route, queue, tier, division, page, cancellationToken).Result;
        }
        ...
        /// <param name="page">Defaults to 1. Starts with page 1. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LeagueV4.LeagueEntry[]> GetLeagueEntriesAsync(PlatformRoute route, Camille.Enums.QueueType queue, Camille.Enums.Tier tier, Camille.Enums.Division division, int? page = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
            if (null != page) queryParams.Add(new KeyValuePair<string?, string?>(nameof(page), page.Value.ToString()));
            HttpRequestMessage request;
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LeagueV4.LeagueList GetGrandmasterLeague(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LeagueV4.LeagueList> GetGrandmasterLeagueAsync(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LeagueV4.LeagueList GetMasterLeague(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<LeagueV4.LeagueList> GetMasterLeagueAsync(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
    ...
    public class LorDeckV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string CreateDeck(RegionalRoute route, LorDeckV1.NewDeck body, string Authorization, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="Authorization">(required, in header)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string> CreateDeckAsync(RegionalRoute route, LorDeckV1.NewDeck body, string Authorization, CancellationToken? cancellationToken = null)
        {
    ...
    public class MatchV5Endpoints : Endpoints
    {
        ...
        /// <param name="route">Route to query. Corresponds to a Riot API subdomain for a region or platform. (required)</param>
        /// <param name="puuid">(required, in path)</param>
        /// <param name="startTime">Epoch timestamp in seconds. The matchlist started storing timestamps on June 16th, 2021. Any matches played before June 16th, 2021 won't be included in the results if the startTime filter is set. (optional, in query)</param>
        /// <param name="endTime">Epoch timestamp in seconds. (optional, in query)</param>
        /// <param name="queue">Filter the list of match ids by a specific queue id. This filter is mutually inclusive of the type filter meaning any match ids returned must match both the queue and type filters. (optional, in query)</param>
        /// <param name="type">Filter the list of match ids by the type of match. This filter is mutually inclusive of the queue filter meaning any match ids returned must match both the queue and type filters. (optional, in query)</param>
        /// <param name="start">Defaults to 0. Start index. (optional, in query)</param>
        /// <param name="count">Defaults to 20. Valid values: 0 to 100. Number of match ids to return. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string[] GetMatchIdsByPUUID(RegionalRoute route, string puuid, int? count = null, long? endTime = null, Camille.Enums.Queue? queue = null, long? startTime = null, int? start = null, string? type = null, CancellationToken? cancellationToken = null)
        {
            return GetMatchIdsByPUUIDAsync(route, puuid, count, endTime, queue, startTime, start, type, cancellationToken).Result;
        }
        ...
        /// <param name="count">Defaults to 20. Valid values: 0 to 100. Number of match ids to return. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string[]> GetMatchIdsByPUUIDAsync(RegionalRoute route, string puuid, int? count = null, long? endTime = null, Camille.Enums.Queue? queue = null, long? startTime = null, int? start = null, string? type = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
            ...
            if (null != queue) queryParams.Add(new KeyValuePair<string?, string?>(nameof(queue), ((int) queue.Value).ToString()));
            ...
            if (null != type) queryParams.Add(new KeyValuePair<string?, string?>(nameof(type), type));
            HttpRequestMessage request;
            using (var content = new FormUrlEncodedContent(queryParams))
    ...
    public class TftLeagueV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TftLeagueV1.LeagueEntry[] GetLeagueEntries(PlatformRoute route, Camille.Enums.Tier tier, string division, int? page = null, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="page">Defaults to 1. Starts with page 1. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<TftLeagueV1.LeagueEntry[]> GetLeagueEntriesAsync(PlatformRoute route, Camille.Enums.Tier tier, string division, int? page = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
            if (null != page) queryParams.Add(new KeyValuePair<string?, string?>(nameof(page), page.Value.ToString()));
            HttpRequestMessage request;
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TftLeagueV1.TopRatedLadderEntry[] GetTopRatedLadder(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required, in path)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<TftLeagueV1.TopRatedLadderEntry[]> GetTopRatedLadderAsync(PlatformRoute route, Camille.Enums.QueueType queue, CancellationToken? cancellationToken = null)
        {
    ...
    public class ValContentV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ValContentV1.Content GetContent(ValPlatformRoute route, Camille.Enums.Locale? locale = null, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="locale">(optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<ValContentV1.Content> GetContentAsync(ValPlatformRoute route, Camille.Enums.Locale? locale = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
