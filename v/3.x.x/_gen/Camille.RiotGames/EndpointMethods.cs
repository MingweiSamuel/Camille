...
// Generated on 2021-10-10T03:33:17.269Z
...
namespace Camille.RiotGames
{
    ...
    public class MatchV5Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string[] GetMatchIdsByPUUID(RegionalRoute route, string puuid, int? count = null, long? endTime = null, int? queue = null, long? startTime = null, int? start = null, string? type = null, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="count">Defaults to 20. Valid values: 0 to 100. Number of match ids to return. (optional, in query)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string[]> GetMatchIdsByPUUIDAsync(RegionalRoute route, string puuid, int? count = null, long? endTime = null, int? queue = null, long? startTime = null, int? start = null, string? type = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string?, string?>>();
