...
namespace Camille.RiotGames
{
    ...
    public class ValMatchV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string GetRecent(ValPlatformRoute route, string queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<string> GetRecentAsync(ValPlatformRoute route, string queue, CancellationToken? cancellationToken = null)
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"/val/match/v1/recent-matches/by-queue/{queue}");
            return @base.Send<string>(route.ToString(), "val-match-v1.getRecent", request, cancellationToken, false);
        }
