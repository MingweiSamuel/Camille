...
// Generated on 2021-05-02T02:38:22.518Z
...
namespace Camille.RiotGames
{
    ...
    public class TftLeagueV1Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TftLeagueV1.TopRatedLadderEntry[] GetTopRatedLadder(PlatformRoute route, string queue, CancellationToken? cancellationToken = null)
        {
        ...
        /// <param name="queue">(required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task. (optional)</param>
        public Task<TftLeagueV1.TopRatedLadderEntry[]> GetTopRatedLadderAsync(PlatformRoute route, string queue, CancellationToken? cancellationToken = null)
        {
