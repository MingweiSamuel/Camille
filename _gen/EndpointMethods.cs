...
// Generated on 2019-11-16T03:04:38.863Z
...
namespace Camille.RiotApi
{
    ...
    public class MatchV4Endpoints : Endpoints
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MatchV4.Matchlist? GetMatchlist(Region region, string encryptedAccountId, long? beginTime = null, int? beginIndex = null, Champion[]? champion = null, long? endTime = null, int? endIndex = null, Queue[]? queue = null, CancellationToken? cancellationToken = null)
        {
            return GetMatchlistAsync(region, encryptedAccountId, beginTime, beginIndex, champion, endTime, endIndex, queue, cancellationToken).Result;
        }
        ...
        /// <param name="beginIndex">The begin index to use for filtering matchlist.  If beginIndex is specified, but not endIndex, then endIndex defaults to beginIndex+100. If endIndex is specified, but not beginIndex, then beginIndex defaults to 0. If both are specified, then endIndex must be greater than beginIndex. The maximum range allowed is 100, otherwise a 400 error code is returned. (optional)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<MatchV4.Matchlist?> GetMatchlistAsync(Region region, string encryptedAccountId, long? beginTime = null, int? beginIndex = null, Champion[]? champion = null, long? endTime = null, int? endIndex = null, Queue[]? queue = null, CancellationToken? cancellationToken = null)
        {
            var queryParams = new List<KeyValuePair<string, string>>();
    ...
    public class TftMatchV1Endpoints : Endpoints
    {
        ...
        {
            return GetMatchIdsByPUUIDAsync(region, encryptedPUUID, cancellationToken).Result;
        }
