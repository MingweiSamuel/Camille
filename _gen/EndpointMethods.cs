...
// Generated on 2019-11-09T03:48:27.726Z
...
namespace Camille.RiotApi
{
    ...
    public class ChampionMasteryV4Endpoints : Endpoints
    {
        ...
        {
            return RiotApi.Get<ChampionMasteryV4.ChampionMastery?>("champion-mastery-v4.getChampionMastery", $"/lol/champion-mastery/v4/champion-masteries/by-summoner/{encryptedSummonerId}/by-champion/{(int)championId}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        {
            return RiotApi.GetAsync<ChampionMasteryV4.ChampionMastery?>("champion-mastery-v4.getChampionMastery", $"/lol/champion-mastery/v4/champion-masteries/by-summoner/{encryptedSummonerId}/by-champion/{(int)championId}",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
    ...
    public class TftMatchV1Endpoints : Endpoints
    {
        ...
        {
            return RiotApi.Get<string[]>("tft-match-v1.getMatchIdsByPUUID", $"/tft/match/v1/matches/by-puuid/{encryptedPUUID}/ids",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
        ...
        {
            return RiotApi.GetAsync<string[]>("tft-match-v1.getMatchIdsByPUUID", $"/tft/match/v1/matches/by-puuid/{encryptedPUUID}/ids",
                region, QUERY_PARAMS_EMPTY, false, cancellationToken);
        }
