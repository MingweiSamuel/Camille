...
// Generated on 2019-05-25T03:00:57.488Z

// http://www.mingweisamuel.com/riotapi-schema/tool/
// Version 4900f8950c53df9115c644413a0a0c2c56f6069c
...
namespace MingweiSamuel.Camille
{
    ...
    public class LeagueV4Endpoints : Endpoints
    {
        ...
        /// <summary>
        /// (Deprecated) Get the queues that have positional ranks enabled.<br />
        /// <br />
        /// <a href="https://developer.riotgames.com/api-methods/#league-v4/GET_getQueuesWithPositionRanks">Official API Reference</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public string[] GetQueuesWithPositionRanks(Region region, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<string[]>("league-v4.getQueuesWithPositionRanks", $"/lol/league/v4/positional-rank-queues",
                region, MakeParams(), false, cancellationToken);
        }
        ...
        /// <param name="region">Region to query.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<string[]> GetQueuesWithPositionRanksAsync(Region region, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<string[]>("league-v4.getQueuesWithPositionRanks", $"/lol/league/v4/positional-rank-queues",
                region, MakeParams(), false, cancellationToken);
        }

        /// <summary>
        /// (Deprecated) Get league positions in all queues for a given summoner ID.<br />
        /// <br />
        /// <a href="https://developer.riotgames.com/api-methods/#league-v4/GET_getAllLeaguePositionsForSummoner">Official API Reference</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="encryptedSummonerId"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public LeagueV4.LeaguePosition[] GetAllLeaguePositionsForSummoner(Region region, string encryptedSummonerId, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<LeagueV4.LeaguePosition[]>("league-v4.getAllLeaguePositionsForSummoner", $"/lol/league/v4/positions/by-summoner/{encryptedSummonerId}",
                region, MakeParams(), false, cancellationToken);
        }
        ...
        /// <param name="encryptedSummonerId"> (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<LeagueV4.LeaguePosition[]> GetAllLeaguePositionsForSummonerAsync(Region region, string encryptedSummonerId, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<LeagueV4.LeaguePosition[]>("league-v4.getAllLeaguePositionsForSummoner", $"/lol/league/v4/positions/by-summoner/{encryptedSummonerId}",
                region, MakeParams(), false, cancellationToken);
        }

        /// <summary>
        /// (Deprecated) Get all the positional league entries.<br />
        /// <br />
        /// <a href="https://developer.riotgames.com/api-methods/#league-v4/GET_getPositionalLeagueEntries">Official API Reference</a>
        /// </summary>
        /// <param name="region">Region to query.</param>
        /// <param name="positionalQueue">Note that the queue value must be a valid positional queue. (required)</param>
        /// <param name="tier"> (required)</param>
        /// <param name="division"> (required)</param>
        /// <param name="position"> (required)</param>
        /// <param name="page">Starts with page 0. (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public LeagueV4.LeaguePosition[] GetPositionalLeagueEntries(Region region, int page, string position, string division, string tier, string positionalQueue, CancellationToken? cancellationToken = null)
        {
            return RiotApi.Get<LeagueV4.LeaguePosition[]>("league-v4.getPositionalLeagueEntries", $"/lol/league/v4/positions/{positionalQueue}/{tier}/{division}/{position}/{page}",
                region, MakeParams(), false, cancellationToken);
        }
        ...
        /// <param name="page">Starts with page 0. (required)</param>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel this task.</param>
        public Task<LeagueV4.LeaguePosition[]> GetPositionalLeagueEntriesAsync(Region region, int page, string position, string division, string tier, string positionalQueue, CancellationToken? cancellationToken = null)
        {
            return RiotApi.GetAsync<LeagueV4.LeaguePosition[]>("league-v4.getPositionalLeagueEntries", $"/lol/league/v4/positions/{positionalQueue}/{tier}/{division}/{position}/{page}",
                region, MakeParams(), false, cancellationToken);
        }
...
{
    /// <summary>
    /// LeaguePosition data object. This class is automatically generated.<br />
    /// 
    /// </summary>
    public class LeaguePosition
    {
        public LeaguePosition([JsonProperty("queueType")] string queueType,
                [JsonProperty("summonerName")] string summonerName,
                [JsonProperty("hotStreak")] bool hotStreak,
                [JsonProperty("miniSeries")] MiniSeries miniSeries,
                [JsonProperty("wins")] int wins,
        ...
        public override string ToString()
        {
            return $"LeaguePosition(QueueType: {QueueType}, SummonerName: {SummonerName}, HotStreak: {HotStreak}, MiniSeries: {MiniSeries}, Wins: {Wins}, Veteran: {Veteran}, Losses: {Losses}, Rank: {Rank}, LeagueId: {LeagueId}, Inactive: {Inactive}, FreshBlood: {FreshBlood}, LeagueName: {LeagueName}, Position: {Position}, Tier: {Tier}, SummonerId: {SummonerId}, LeaguePoints: {LeaguePoints})";
        }
    }
}
