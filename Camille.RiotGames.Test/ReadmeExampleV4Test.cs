...
namespace Camille.RiotGames.Test
{
    ...
    public class ReadmeExampleTest : ApiTest
    {
        ...
        //    var summonerData = await riotApi.SummonerV4().GetBySummonerNameAsync(PlatformRoute.NA1, summonerNameQuery);
        ...
        //        PlatformRoute.NA1, summonerData.AccountId, queue: new[] { Queue.SUMMONERS_RIFT_5V5_RANKED_SOLO }, endIndex: 10);
        //    // Get match results (done asynchronously -> not blocking -> fast).
        //    var matchDataTasks = matchlist.Matches.Select(
        //            matchMetadata => riotApi.MatchV4().GetMatchAsync(PlatformRoute.NA1, matchMetadata.GameId)
        //        ).ToArray();
